...
export function validateAccountsFormData(name, number) {
	...
	if (name.length > 20)
		errorMsg += "The name cannot be longer than 20 characters.\n"
	if (number == null || number == "") errorMsg += "You must enter an amount (decimal point is a dot not a comma e.g 45.78).\n"
...
export function validateCategoriesFormData(name, number) {
	...
	if (name.length > 20)
		errorMsg += "The name cannot be longer than 20 characters.\n"
	if (number == null || number == "") errorMsg += "You must enter a budget (decimal point is a dot not a comma e.g 45.78).\n"
