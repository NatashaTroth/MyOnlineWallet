...
import {roundToTwoDecimals, convertCurrencyToString, calculatePercentSpent}from "../modules/globalFunctions";
...
export function renderCategories(allCategories) {
    ...
    allCategories.forEach(category => {
      ...
      let spentPercent = calculatePercentSpent(parseFloat(category.spent), parseFloat(category.remaining))
      ...
      categoryBlock.appendChild(
        ...
        <div class="main__child2__categories__js-progressbar--back">
          <div class="main__child2__categories__js-progressbar--front">
             <span class="main__child2__categories__js-progressbar__text--remaining"></span>
          </div>
        </div>
        </article>
      );

      let progressbar = document.querySelector(".main__child2__categories__" + category.name + " .main__child2__categories__js-progressbar--front")
