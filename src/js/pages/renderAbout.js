...
export function renderAbout() {
  ...
  main.appendChild(
    <article class="about__article media-block">
      ...
      <p>
        Accounts are the different places you have money. For example: common
        accounts can be bank, credit card, cash or event your piggy bank. When
        adding an income or outgoing you choose an account to define what the
        payment type of that income/outgoing was. When creating an account, you
        give it a name and the current amount of money you have for this
        account.
      </p>
      ...
      <h3 class="about__article__h3">Income/Outgoing</h3>
      <p>
