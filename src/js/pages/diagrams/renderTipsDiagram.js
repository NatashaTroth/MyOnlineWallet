...
export function renderDiagramTips() {
  ...
  console.log('renderDiagramTips')

  let tips = [
    'Create a shopping list prior to going shopping. If you have a list, then you know exactly what you need to buy and are less likely to look at and be tempted by items you don’t need. ',
    'Buy gift cards for online shops instead of paying with a credit card since these give you a spending limit. When the balance is empty, you will no  longer be able to make purchases.',
    ...
    'When shopping for food, be sure to keep an eye out for offers. If you shop for bargains,  not only will you save money but you will also have your meal plan ready for the days to come.',
    'It is a good idea to store all money you don’t currently need in a savings account. These usually have higher interest rates and the money is that little bit harder to access. ',
...
export function changeToTipsNextPage(tips, icons, colorsForTips, n) {
  ...
  while (i < n + 4) {
    ...
    tip_text.innerHTML = tips[i % tipsAmount]
